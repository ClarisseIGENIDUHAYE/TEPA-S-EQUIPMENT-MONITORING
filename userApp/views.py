...
def get_forgetpassword_page(request):
...
###################################
        ...
        if email:
            message = (
                "Hello,\n\nYour account has been created in TEPA's Equipment Monitoring & Management System.\n"
...
def reset_password(request):
    ...
    try:
        ...
        send_mail(
            ...
            message=f"Your password has been reset to TEPA's Equipment Monitoring & Management System.\n Your new password is: {new_password}",
            from_email="no-reply@anaweza.com",
        ...
        return Response({"error": "User with this email number does not exist."}, status=404)
...
def list_all_users(request):
    ...
    users = CustomUser.objects.all().values(
        'id', 'first_name', 'last_name', 'phone_number', 'email', 'role', 'status', 'created_at', 'profile_picture',
    )
