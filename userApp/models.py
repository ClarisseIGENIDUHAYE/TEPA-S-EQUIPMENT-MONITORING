...
class CustomUserManager(BaseUserManager):
    def create_user(self, first_name, last_name, phone_number, role, email=None, password=None, status=True, profile_picture=None):
        if not phone_number:
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    REQUIRED_FIELDS = ['email','first_name', 'last_name']  # Required only for createsuperuser command
